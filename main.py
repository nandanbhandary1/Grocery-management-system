...
storeName = "*Grocery Management System For Retail*"
...
def insert(id, name, price, quantity):
    ...
    cursor.execute("INSERT INTO inventory VALUES ('" + str(id) + "','" + str(name) + "','" + str(price) + "','" +
    str(quantity) + "')")
    conn.commit()
...
def delete_data():
    ...
    my_tree.tag_configure('orow', background='#87C4FF')
    my_tree.grid(row=1, column=5, columnspan=4, rowspan=5, padx=10, pady=10)
...
my_tree.tag_configure('orow', background='#87C4FF', font=('Arial bold', 15))
my_tree.grid(row=1, column=5, columnspan=4, rowspan=5, padx=10, pady=10)
